...
const withClapAnimation = (WrappedComponent) => {
  class WithClapAnimation extends Component {
    ...
    componentDidMount() {
      const newAnimationTimeline = initializeAnimationTimeline(this.animationTimeline)
...
export function initializeAnimationTimeline(animationTimeline) {
...
export const MediumClap = ({ animationTimeline }) => {
